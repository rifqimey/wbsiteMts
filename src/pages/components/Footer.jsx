            ...
            <div className="container mx-auto px-4 md:px-24 border-gray-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-y-8 text-center sm:text-left">
                    ...
                    <div className="col-span-1 space-y-6 sm:ml-auto">
                        <h3 className="text-xl font-bold mb-4 text-green-800 text-center">Media Sosial</h3>
                        <div className="flex justify-center space-x-6">
                            ...
                            <svg
                                ...
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                className="w-6 h-6 text-gray-800 hover:text-pink-500 hover:scale-110 transition-colors cursor-pointer"
                            >
